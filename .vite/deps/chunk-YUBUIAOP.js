...
var OutlinedInput = React70.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime50.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime50.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime49.jsxs)(React70.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YUBUIAOP.js.map
